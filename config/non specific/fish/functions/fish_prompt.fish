 function fish_prompt
  ...
  ## Line 1
  ##
  echo -n $hotpink'╭─'$hotpink$current_user$white' at '$blue$__fish_prompt_hostname$white' in '$turquoise(pwd|sed "s=$HOME=~=")$turquoise
  __fish_git_prompt " (%s)"
  echo
  ...
  ## Rest of the prompt
  ##
  echo -n $hotpink'─'$white$__fish_prompt_char $normal
end
